...
/// Basis points per whole percentage unit.
///
/// 1% = 100 basis points.  This constant is the multiplier that converts
/// a whole-percentage value into its basis-points equivalent.
pub const BPS_PER_PERCENT: u32 = 100;

/// Alias for [`BPS_PER_PERCENT`] for readability.
